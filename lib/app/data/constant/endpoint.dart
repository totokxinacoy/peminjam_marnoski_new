class Endpoint {
  static const String baseUrlApi = "http://192.168.5.144:8000/api/v1/user/";
  static const String baseUrlApi1 = "http://192.168.5.144:8000/api/v1/petugas/";
  static const String image = "http://192.168.5.144:8000/images/";
